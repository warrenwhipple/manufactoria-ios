...
struct Globals {
  ...
  static let strokeColor =         UIColor(hue: 0.10, saturation: 1.0, brightness: 0.4, alpha: 1)
  //static let backgroundColor =     UIColor.whiteColor()
  static let backgroundColor =     UIColor(hue: 0.10, saturation: 0.2, brightness: 1.0, alpha: 1)
